...
import helpEnd from "../../assets/img/helpEnd.png";
...
export default function Portfolio() {
  let gitHubHelpEnd = "https://github.com/hetagdarchiev/HelpEnd";
  ...
  return (
    <section id={"portfolio"} className={`${style.portfolio} container`}>
      ...
      <div className="portfolio-wrapper">
        <Item img={helpEnd} title={"LibreX"} link={gitHubHelpEnd}>
          <ul>
            <li>html</li>
            <li>scss</li>
            <li>react</li>
            <li>react route</li>
            <li>Date: 17.09.2025</li>
          </ul>
        </Item>
